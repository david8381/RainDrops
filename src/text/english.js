...
export const RainMathText = {
  ...
  welcome: {
    ...
    playerTitle: "Player",
    playerSubtitle: "Progress saves locally in this browser. Use Login to switch, create, clear, back up, or restore players.",
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Profiles live in this browser's localStorage for now. Use Login to switch, create, clear, back up, or restore players. Use Test Me to choose a starting level, Grid to inspect mastery, and Log to review recent sessions.",
