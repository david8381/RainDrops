...
export const RainMathText = {
  ...
  welcome: {
    ...
    actionSubtitle: "Go to the game board, or take the guided tour first.",
    tutorial: "Tutorial",
    testMe: "Test Me",
    ...
    steps: [
      {
        ...
        body: "Choose at least one problem type, then press Start. Arithmetic and x10 can mix; Rounding, Simplify Fractions, Shapes, SI, Powers & Roots, and factoring stay in their own lanes so answers do not collide.",
        tip: "",
      },
      {
        target: ".game",
      ...
      },
      {
        ...
        body: "SI conversions use answers like *1000 or /100 and need Enter. Simplify Fractions accepts lowest-terms answers like 2/3 plus Enter; or type a common factor and it auto-reduces (with a brief factoring flash), then press Enter once it is in lowest terms. Prime factorization accepts full answers like 2^2*3 plus Enter, or Tab to target and factor step by step. Tab and Shift+Tab switch step targets.",
      ...
      },
      {
        ...
        tip: "Finish opens once there is activity to report. It stops new drops and opens this sitting's Report to share. Brief reloads continue the same session; a long break or player switch starts a new one.",
      },
    ],
  },
};
