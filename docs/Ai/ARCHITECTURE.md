...
9. The Login popup creates or switches local profiles. Switching saves the outgoing profile, loads the selected profile's settings/progress, and clears only transient run state such as active drops and the Cleared counter.
