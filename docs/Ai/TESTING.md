...
- Browser tests cover loading, canvas paint, operation toggles, difficulty/readiness controls, Speed/Drops controls, Grid hints and hover tooltips for stats popups, falling-drop accuracy/evidence shading, Spacebar Breather mode, boss readiness locking and boss-before-level-advance gating, boss HUD/stun behavior, locked boss Speed/Drops and level-control behavior, persisted unlocked-level reloads, Blitz shield scoring, full Wave 1/Wave 2/mothership boss sequencing, Wave/Boss replay buttons, immediate numeric clearing, Enter-required SI and factorization answers, Tab-targeted factorization, pause/restart, local login/profile switching, clear-stats, feedback, stats/results overlays, and mobile keypad/layout controls.
