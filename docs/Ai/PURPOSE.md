...
- The Tutorial is an in-app stepper that highlights real controls and explains problem types, typing rules, Speed/Drops pressure, mastery grids, Spacebar Breather, boss mode, and local profiles/session logs.
