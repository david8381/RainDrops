...
- Blitz, Wave, and Worksheet replay buttons appear when the selected level is already unlocked behind the current working level. Blitz is a shield-endurance survival run; Wave is a simultaneous-load run; Worksheet records time without advancing content level. Higher-level challenge results can supersede lower-level displayed bests when they are better.
